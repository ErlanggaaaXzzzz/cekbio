...
const initWhatsApp = async (sessionName, userId, method = 'qr', phoneNumber = '') => {
  ...
  // Opsi koneksi Baileys yang disesuaikan agar pairing code dapat dipicu dengan benar
  ...
  if (method === 'pairing' && !sock.authState.creds.registered && phoneNumber) {
    ...
    }, 3000); // Menggunakan jeda waktu aman (3 detik) agar socket siap menerima request kode penautan
  }
